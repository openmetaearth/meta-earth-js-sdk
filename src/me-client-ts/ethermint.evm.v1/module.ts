...
import { VFBCPair as typeVFBCPair } from './types'
...
import { VirtualFrontierContract as typeVirtualFrontierContract } from './types'
import { VFBankContractMetadata as typeVFBankContractMetadata } from './types'
import { UpdateVirtualFrontierBankContractsProposal as typeUpdateVirtualFrontierBankContractsProposal } from './types'
import { VirtualFrontierBankContractProposalContent as typeVirtualFrontierBankContractProposalContent } from './types'
...
export const txClient = (
  ...
  return {
    async sendMsgEthereumTx({
      value,
      fee,
      memo,
    }: sendMsgEthereumTxParams): Promise<DeliverTxResponse> {
      if (!signer) {
...
class SDKModule {
  ...
  constructor(client: IgniteClient) {
    ...
    this.structure = {
      ...
      VFBCPair: getStructure(typeVFBCPair.fromPartial({})),
      ...
      VirtualFrontierContract: getStructure(typeVirtualFrontierContract.fromPartial({})),
      VFBankContractMetadata: getStructure(typeVFBankContractMetadata.fromPartial({})),
      UpdateVirtualFrontierBankContractsProposal: getStructure(
        typeUpdateVirtualFrontierBankContractsProposal.fromPartial({}),
      ),
      VirtualFrontierBankContractProposalContent: getStructure(
        typeVirtualFrontierBankContractProposalContent.fromPartial({}),
      ),
    }
