 ...
 */
export type WnftMsgMintNFTResponse = object
...
export interface WnftQueryClassAddressResponse {
  exists?: boolean
...
export interface WnftQueryNftFilterRequest {
  owner?: string
  class_id?: string
  token_id?: string
}

export interface WnftQueryNftFilterResponse {
  nfts?: WnftNftList[]
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryClassAddress = (address: string, classId: string, params: RequestParams = {}) =>
    this.request<WnftQueryClassAddressResponse, RpcStatus>({
   ...
   */
  queryNftFilter = (body: WnftQueryNftFilterRequest, params: RequestParams = {}) =>
    this.request<WnftQueryNftFilterResponse, RpcStatus>({
