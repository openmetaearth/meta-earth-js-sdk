...
/**
 * @title metaearth/eibc/demand_order.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/metaearth/eibc/demand_orders/{status}
   */
  queryDemandOrdersByStatus = (
    ...
    this.request<EibcQueryDemandOrdersByStatusResponse, GooglerpcStatus>({
      path: `/metaearth/eibc/demand_orders/${status}`,
      method: 'GET',
      query: query,
      format: 'json',
      ...params,
   ...
   * @request GET:/metaearth/eibc/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<EibcQueryParamsResponse, GooglerpcStatus>({
      path: `/metaearth/eibc/params`,
      method: 'GET',
      format: 'json',
      ...params,
    })
