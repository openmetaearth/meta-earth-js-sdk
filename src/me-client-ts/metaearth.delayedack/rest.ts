...
/**
 * @title metaearth/delayedack/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/metaearth/delayedack/packets/{rollappId}/{status}
   */
  queryGetPackets = (
    rollappId: string,
    ...
    this.request<DelayedackQueryRollappPacketListResponse, GooglerpcStatus>({
      path: `/metaearth/delayedack/packets/${rollappId}/${status}`,
      method: 'GET',
      query: query,
      format: 'json',
      ...params,
   ...
   * @request GET:/metaearth/delayedack/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DelayedackQueryParamsResponse, GooglerpcStatus>({
      path: `/metaearth/delayedack/params`,
      method: 'GET',
      format: 'json',
      ...params,
    })
