...
/**
 * @title metaearth/rollapp/block_descriptor.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/metaearth/rollapp/latest_height/{rollappId}
   */
  queryLatestHeight = (
    rollappId: string,
    ...
    this.request<RollappQueryGetLatestHeightResponse, GooglerpcStatus>({
      path: `/metaearth/rollapp/latest_height/${rollappId}`,
      method: 'GET',
      query: query,
      format: 'json',
      ...params,
   ...
   * @request GET:/metaearth/rollapp/latest_state_index/{rollappId}
   */
  queryLatestStateIndex = (
    ...
    this.request<RollappQueryGetLatestStateIndexResponse, GooglerpcStatus>({
      path: `/metaearth/rollapp/latest_state_index/${rollappId}`,
      method: 'GET',
      query: query,
      format: 'json',
      ...params,
   ...
   * @request GET:/metaearth/rollapp/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<RollappQueryParamsResponse, GooglerpcStatus>({
      path: `/metaearth/rollapp/params`,
      method: 'GET',
      format: 'json',
      ...params,
    })
   ...
   * @request GET:/metaearth/rollapp/rollapp
   */
  queryRollappAll = (
    query?: {
    ...
    this.request<RollappQueryAllRollappResponse, GooglerpcStatus>({
      path: `/metaearth/rollapp/rollapp`,
      method: 'GET',
      query: query,
      format: 'json',
      ...params,
   ...
   * @name QueryRollapp
   * @summary Queries a Rollapp by index.
   * @request GET:/metaearth/rollapp/rollapp/{rollappId}
   */
  queryRollapp = (rollappId: string, params: RequestParams = {}) =>
    this.request<RollappQueryGetRollappResponse, GooglerpcStatus>({
      path: `/metaearth/rollapp/rollapp/${rollappId}`,
      method: 'GET',
      format: 'json',
      ...params,
    })
   ...
   * @request GET:/metaearth/rollapp/state_info/{rollappId}/{index}
   */
  queryStateInfo = (
    rollappId: string,
    index: string,
    ...
    this.request<RollappQueryGetStateInfoResponse, GooglerpcStatus>({
      path: `/metaearth/rollapp/state_info/${rollappId}/${index}`,
      method: 'GET',
      query: query,
      format: 'json',
      ...params,
