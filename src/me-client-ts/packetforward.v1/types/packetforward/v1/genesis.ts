  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      inFlightPackets: isObject(object.inFlightPackets)
        ? Object.entries(object.inFlightPackets).reduce<{ [key: string]: InFlightPacket }>(
            (acc, [key, value]) => {
...
export const InFlightPacket = {
  ...
  fromJSON(object: any): InFlightPacket {
    return {
      originalSenderAddress: isSet(object.originalSenderAddress)
        ? String(object.originalSenderAddress)
        : '',
      ...
      packetTimeoutTimestamp: isSet(object.packetTimeoutTimestamp)
        ? Number(object.packetTimeoutTimestamp)
        : 0,
      packetTimeoutHeight: isSet(object.packetTimeoutHeight)
        ? String(object.packetTimeoutHeight)
        : '',
  ...
  toJSON(message: InFlightPacket): unknown {
    ...
    message.refundSequence !== undefined &&
      (obj.refundSequence = Math.round(message.refundSequence))
