...
import { Stake, UnbondingStake } from './stake'
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.fixedDepositList) {
      FixedDeposit.encode(v!, writer.uint32(90).fork()).ldelim()
    }
    if (message.fixedDepositCount !== 0) {
      writer.uint32(96).uint64(message.fixedDepositCount)
    }
    if (message.exported === true) {
      writer.uint32(104).bool(message.exported)
    }
    return writer
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.unbondingStakes) {
      obj.unbondingStakes = message.unbondingStakes.map((e) =>
        e ? UnbondingStake.toJSON(e) : undefined,
      )
    } else {
      obj.unbondingStakes = []
    }
    ...
    message.fixedDepositCount !== undefined &&
      (obj.fixedDepositCount = Math.round(message.fixedDepositCount))
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.unbondingStakes =
      object.unbondingStakes?.map((e) => UnbondingStake.fromPartial(e)) || []
    message.regions = object.regions?.map((e) => Region.fromPartial(e)) || []
    message.fixedDepositList =
      object.fixedDepositList?.map((e) => FixedDeposit.fromPartial(e)) || []
