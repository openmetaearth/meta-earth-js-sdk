...
export const Region = {
  ...
  fromJSON(object: any): Region {
    return {
      ...
      depositInterestAddr: isSet(object.depositInterestAddr)
        ? String(object.depositInterestAddr)
        : '',
      ...
      fixedDepositAmount: isSet(object.fixedDepositAmount) ? String(object.fixedDepositAmount) : '',
    }
  },
  ...
  toJSON(message: Region): unknown {
    ...
    message.regionTreasureAddr !== undefined &&
      (obj.regionTreasureAddr = message.regionTreasureAddr)
    message.depositInterestAddr !== undefined &&
    ...
    message.fixedDepositAmount !== undefined &&
