...
export const txClient = (
  ...
  return {
    async sendMsgInstantiateContract({
      ...
      gas = 0,
      memo,
    }: sendMsgInstantiateContractParams): Promise<{
      tx_bytes: string
    }> {
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgInstantiateContract: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        ...
        const { gasUsed } = await this.simulateInstantiateContractGas({ value })
        if (!gasUsed) throw Error(`sendMsgInstantiateContract: gasUsed error`)
    ...
    async sendMsgInstantiateContract2({
      ...
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgInstantiateContract2: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
        ...
        let msg = this.msgInstantiateContract2({
          value: MsgInstantiateContract2.fromPartial(value),
        })
        return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
      } catch (e: any) {
        throw new Error(
          'TxClient:sendMsgInstantiateContract2: Could not broadcast Tx: ' + e.message,
        )
      }
    },
    ...
    async sendMsgUpdateInstantiateConfig({
      ...
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgUpdateInstantiateConfig: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
        ...
        let msg = this.msgUpdateInstantiateConfig({
          value: MsgUpdateInstantiateConfig.fromPartial(value),
        })
        return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
      } catch (e: any) {
        throw new Error(
          'TxClient:sendMsgUpdateInstantiateConfig: Could not broadcast Tx: ' + e.message,
        )
      }
    },

    async sendMsgUnpinCodes({
      value,
      fee,
      memo,
    }: sendMsgUnpinCodesParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgStoreAndInstantiateContract({
      ...
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgStoreAndInstantiateContract: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
        ...
        let msg = this.msgStoreAndInstantiateContract({
          value: MsgStoreAndInstantiateContract.fromPartial(value),
        })
        return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
      } catch (e: any) {
        throw new Error(
          'TxClient:sendMsgStoreAndInstantiateContract: Could not broadcast Tx: ' + e.message,
        )
      }
    },

    async sendMsgClearAdmin({
      value,
      fee,
      memo,
    }: sendMsgClearAdminParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgIBCCloseChannel({
      value,
      fee,
      memo,
    }: sendMsgIBCCloseChannelParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgIBCCloseChannel: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
    ...
    async sendMsgSudoContract({
      value,
      fee,
      memo,
    }: sendMsgSudoContractParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgExecuteContract({ value, gas = 0, memo }: sendMsgExecuteContractParams): Promise<{
      tx_bytes: string
    }> {
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgExecuteContract: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
        ...
        const { gasUsed } = await this.simulateExecuteContractGas({ value })
        if (!gasUsed) throw Error(`sendMsgExecuteContract: gasUsed error`)
        const gas_fee = getFinalGas(gasUsed, gas)
        let fee = {
          amount: [{ denom: 'umec', amount: `${gas_fee}` }],
          gas: gas_max_set,
    ...
    async sendMsgUpdateAdmin({
      value,
      fee,
      memo,
    }: sendMsgUpdateAdminParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgAddCodeUploadParamsAddresses({
      ...
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgAddCodeUploadParamsAddresses: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
        ...
        let msg = this.msgAddCodeUploadParamsAddresses({
          value: MsgAddCodeUploadParamsAddresses.fromPartial(value),
        })
        return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
      } catch (e: any) {
        throw new Error(
          'TxClient:sendMsgAddCodeUploadParamsAddresses: Could not broadcast Tx: ' + e.message,
        )
      }
    },

    async sendMsgMigrateContract({
      value,
      fee,
      memo,
    }: sendMsgMigrateContractParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgMigrateContract: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
    ...
    async sendMsgStoreCode({ value, gas = 0, memo }: sendMsgStoreCodeParams): Promise<{
      tx_bytes: string
    }> {
      if (!signer) {
    ...
    async sendMsgRemoveCodeUploadParamsAddresses({
      ...
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgRemoveCodeUploadParamsAddresses: Unable to sign Tx. Signer is not present.',
        )
      }
      try {
        const { address } = (await signer.getAccounts())[0]
        ...
        throw new Error(
          'TxClient:sendMsgRemoveCodeUploadParamsAddresses: Could not broadcast Tx: ' + e.message,
        )
      }
    },
    ...
    msgUpdateInstantiateConfig({ value }: msgUpdateInstantiateConfigParams): EncodeObject {
      try {
        ...
        throw new Error(
          'TxClient:MsgUpdateInstantiateConfig: Could not create message: ' + e.message,
        )
      }
    },
    ...
    msgStoreAndInstantiateContract({ value }: msgStoreAndInstantiateContractParams): EncodeObject {
      try {
        ...
        throw new Error(
          'TxClient:MsgStoreAndInstantiateContract: Could not create message: ' + e.message,
        )
      }
    },
    ...
    msgIBCCloseChannel({ value }: msgIBCCloseChannelParams): EncodeObject {
      try {
        return {
          ...
          value: MsgIBCCloseChannel.fromPartial(value),
        }
      } catch (e: any) {
    ...
    msgAddCodeUploadParamsAddresses({
      value,
    }: msgAddCodeUploadParamsAddressesParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          'TxClient:MsgAddCodeUploadParamsAddresses: Could not create message: ' + e.message,
        )
      }
    },
    ...
    msgRemoveCodeUploadParamsAddresses({
      value,
    }: msgRemoveCodeUploadParamsAddressesParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          'TxClient:MsgRemoveCodeUploadParamsAddresses: Could not create message: ' + e.message,
        )
      }
    },

    async simulateInstantiateContractGas({ value, gas = 50000 }) {
      if (!signer) {
        throw new Error(
          'TxClient:simulateInstantiateContractGas: Unable to sign Tx. Signer is not present.',
        )
      }
    ...
    async simulateExecuteContractGas({ value, gas = 50000 }) {
      if (!signer) {
        throw new Error(
          'TxClient:simulateExecuteContractGas: Unable to sign Tx. Signer is not present.',
        )
      }
      let { address } = (await signer.getAccounts())[0]
      let signingClient = await SigningStargateClient.offline(signer, { registry })
    ...
    async simulateStoreCodeGas({ value, gas = 50000 }) {
      if (!signer) {
...
class SDKModule {
  ...
  constructor(client: IgniteClient) {
    ...
    this.structure = {
      ContractExecutionAuthorization: getStructure(
        typeContractExecutionAuthorization.fromPartial({}),
      ),
      ContractMigrationAuthorization: getStructure(
        typeContractMigrationAuthorization.fromPartial({}),
      ),
      ...
      UpdateInstantiateConfigProposal: getStructure(
        typeUpdateInstantiateConfigProposal.fromPartial({}),
      ),
      StoreAndInstantiateContractProposal: getStructure(
        typeStoreAndInstantiateContractProposal.fromPartial({}),
      ),
