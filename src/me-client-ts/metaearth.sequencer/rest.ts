...
/**
 * @title metaearth/sequencer/description.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/metaearth/sequencer/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<SequencerQueryParamsResponse, RpcStatus>({
      path: `/metaearth/sequencer/params`,
      method: 'GET',
      format: 'json',
      ...params,
    })
   ...
   * @request GET:/metaearth/sequencer/sequencer
   */
  querySequencers = (
    query?: {
    ...
    this.request<SequencerQuerySequencersResponse, RpcStatus>({
      path: `/metaearth/sequencer/sequencer`,
      method: 'GET',
      query: query,
      format: 'json',
      ...params,
   ...
   * @request GET:/metaearth/sequencer/sequencers_by_rollapp/{rollappId}
   */
  querySequencersByRollapp = (rollappId: string, params: RequestParams = {}) =>
    this.request<SequencerQueryGetSequencersByRollappResponse, RpcStatus>({
      path: `/metaearth/sequencer/sequencers_by_rollapp/${rollappId}`,
      method: 'GET',
      format: 'json',
      ...params,
    })
   ...
   * @request GET:/metaearth/sequencer/sequencers_by_rollapp/{rollappId}/{status}
   */
  querySequencersByRollappByStatus = (
    ...
    this.request<SequencerQueryGetSequencersByRollappByStatusResponse, RpcStatus>({
      path: `/metaearth/sequencer/sequencers_by_rollapp/${rollappId}/${status}`,
      method: 'GET',
      format: 'json',
      ...params,
    })
